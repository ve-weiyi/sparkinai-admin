...
const modalConfig: IModalConfig<any> = {
  ...
  formItems: [
    ...
    { label: "模型名称", prop: "name", type: "input", rules: [{ required: true, message: "请输入模型名称" }] },
    { label: "模型代码", prop: "code", type: "input", rules: [{ required: true, message: "请输入模型代码" }] },
    {
      label: "模型类型",
      prop: "model_type",
      type: "select",
    ...
    { label: "视觉支持", prop: "support_vision", type: "switch", attrs: { activeValue: 1, inactiveValue: 0, activeText: "支持", inactiveText: "不支持" } },

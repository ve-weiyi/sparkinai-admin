...
const menuFormData = ref<UpdateMenuReq>();
...
function convertRouteToMenu(
  ...
  const children: CreateMenuReq[] = route.children
 ...
 * 转换路由数组为菜单数组
 */
function convertMenu(routes: RouteRecordRaw[], buttonsCache: Record<string, any>): CreateMenuReq[] {
